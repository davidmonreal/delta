...
- Presentation components should not contain business logic; keep them props-driven.
- See `docs/ENGINEERING_GUIDE.md` for the detailed consistency criteria.
...
- Use strategies/policies for matching, visibility, or heuristics; avoid embedding them in repositories.
...
- Before commit/push, run `npm run lint` and ensure it is clean.
