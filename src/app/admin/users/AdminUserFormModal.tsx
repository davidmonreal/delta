...
import ManagerAliasSelector from "./ManagerAliasSelector";
    ...
    >
      <div className="w-full max-w-xl rounded-3xl bg-white p-6 shadow-xl">
        ...
        <form className="mt-6 space-y-4" action={formAction} autoComplete="off">
          ...
          <label className="flex flex-col gap-2 text-xs font-semibold text-slate-500">
            Àlies de gestor assignats (Assignar factures òrfenes)
            <ManagerAliasSelector initialAliases={initialValues.managerAliases} />
          </label>
